-- Empire Builder - Supabase Authentication Tables (Simplified)
-- Run these commands in your Supabase SQL editor to create the authentication tables

-- Step 1: Create users table (without foreign key constraint initially)
...
DO $$
BEGIN
    RAISE NOTICE 'Empire Builder authentication tables created successfully!';
